        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isMenuOpen && (
            <div className="lg:hidden pb-4 space-y-2">
              ...
              <Link href="/faq" className={`block px-4 py-2 ${isDarkMode ? 'text-white bg-slate-800' : 'text-slate-800 bg-slate-100'} rounded-lg font-medium`} onClick={() => setIsMenuOpen(false)}>
                FAQ
              </Link>
